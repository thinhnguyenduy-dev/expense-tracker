  ...
  return (
    <Card className="bg-slate-800/50 border-slate-700 mt-6">
      <CardHeader>
        ...
        <CardDescription className="text-slate-400">{t('transferHistoryDesc')}</CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
            <TableRow className="border-slate-700 hover:bg-slate-800">
              ...
              <TableHead className="text-slate-400">{t('from')}</TableHead>
              <TableHead className="text-slate-400"></TableHead>
              <TableHead className="text-slate-400">{t('to')}</TableHead>
              <TableHead className="text-slate-400 text-right">{tCommon('amount')}</TableHead>
              <TableHead className="text-slate-400">{t('note')}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {transfers.map((transfer) => (
              <TableRow key={transfer.id} className="border-slate-700 hover:bg-slate-800/50">
